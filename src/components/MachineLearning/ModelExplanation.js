...
const ModelExplanation = ({ explanations, loading }) => { // function to display the model explanation
  ...
  const [activeConfusionMatrix, setActiveConfusionMatrix] = useState('test'); // state variable to store the active confusion matrix
  
  console.log('Received explanations data:', explanations); // log the received explanations data
